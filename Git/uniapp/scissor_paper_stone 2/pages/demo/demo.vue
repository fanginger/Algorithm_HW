		...
		<view class="uni-padding-wrap uni-flex uni-column ">
			<view>
				...
				<view class="uni-flex uni-row " style="flex-wrap: wrap;">
					...
					<view v-for="(item,index2) in player" :key="index2" v-if="player.length === 4" style="height: 50;">
						<view class="uni-flex-item-with-height-2 uni-bg-red">{{item.name}}


							<button class="uni-bg-red" position="button" @click="show_his(item.name)" style="height: 20;">
